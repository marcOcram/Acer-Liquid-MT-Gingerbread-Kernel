...
#include <mach/qdsp5v2/marimba_a4_profile.h>
#elif defined(CONFIG_MACH_ACER_A5)
#include <mach/qdsp5v2/marimba_a5_profile.h>
#else
...
static struct snddev_icodec_data snddev_imic_data = {
	...
	.pamp_on = msm_snddev_mic1_pmic_on,
	.pamp_off = msm_snddev_mic1_pmic_off,
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
#if defined(CONFIG_MACH_ACER_A5)
	.pamp_on = msm_snddev_dualmic_pmic_on,
	.pamp_off = msm_snddev_dualmic_pmic_off,
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
static struct snddev_icodec_data snddev_ihs_stereo_speaker_stereo_rx_data = {
	...
	.default_sample_rate = 48000,
#if defined(CONFIG_MACH_ACER_A4) || defined(CONFIG_MACH_ACER_A5)
	.pamp_on = msm_snddev_hsed_spk_pamp_on,
	.pamp_off = msm_snddev_hsed_spk_pamp_off,
	.voltage_on = NULL,
	.voltage_off = NULL,
#else
	.pamp_on = msm_snddev_poweramp_on,
...
static struct adie_codec_action_unit ihs_stereo_fm_rx_48KHz_osr256_actions[] =
	HEADSET_STEREO_FM_RX_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry ihs_stereo_fm_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_stereo_fm_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_stereo_fm_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ihs_stereo_fm_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ihs_stereo_fm_rx_settings,
	.setting_sz = ARRAY_SIZE(ihs_stereo_fm_rx_settings),
};

static struct snddev_icodec_data snddev_ihs_stereo_fm_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "headset_stereo_fm_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_STEREO,
	.profile = &ihs_stereo_fm_rx_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
#if defined(CONFIG_MACH_ACER_A4) || defined(CONFIG_MACH_ACER_A5)
	.pamp_on = msm_snddev_hsed_pamp_on,
...
static struct platform_device msm_ihs_stereo_fm_rx_device = {
	.name = "snddev_icodec",
	.id = 32,
	.dev = { .platform_data = &snddev_ihs_stereo_fm_rx_data },
};
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt530_earpiece_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT530_SPKR,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt530_mic_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT530_MIC,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt2050_earpiece_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT2050_SPKR,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt2050_mic_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT2050_MIC,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt2070_earpiece_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT2070_SPKR,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_jabra_bt2070_mic_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT2070_MIC,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_nokia_bh103_earpiece_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT103_SPKR,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_nokia_bh103_mic_data = {
	...
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_BT103_MIC,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_sony_ds980_ds220_earpiece_data = {
	...
	.name = "bt_sco_ds_rx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_DS220_DS980_SPKR,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_sony_ds980_ds220_mic_data = {
	...
	.name = "bt_sco_ds_tx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_DS220_DS980_MIC,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
