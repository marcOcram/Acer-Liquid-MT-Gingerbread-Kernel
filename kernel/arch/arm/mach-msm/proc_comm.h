...
enum {
	...
	ACER_SMEM_PROC_CMD_CHG_PWR_OFF,         // Power off device in charging mode
	ACER_SMEM_PROC_CMD_HW_CTRL_VIBRATOR,    // Vibrator delay
	ACER_SMSM_PROC_CMD_READ_CLEAN_BOOT,     // Read clean boot flag
	ACER_SMSM_PROC_CMD_SET_CLEAN_BOOT,      // Clear clean boot flag
	ACER_SMSM_PROC_CMD_SET_DETECT_USB,
	ACER_SMEM_PROC_CMD_OS_RAM_DUMP,
	ACER_SMEM_PROC_CMD_PM_GPIO_CONFIG,      //PMIC GPIO26 Backlight control
